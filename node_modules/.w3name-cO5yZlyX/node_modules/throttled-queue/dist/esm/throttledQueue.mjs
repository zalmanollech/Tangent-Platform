...
export function throttledQueue(options = {}) {
    const { interval = 0, maxPerInterval = Infinity, evenlySpaced = false, maxRetries = DEFAULT_RETRY_LIMIT, maxRetriesWithPauses = DEFAULT_RETRY_LIMIT, } = options;
    if (maxPerInterval < 1) {
            ...
            try {
                ...
                if (err instanceof RetryError) {
                    ...
                    if (err.options.pauseQueue) {
                        ...
                        timeout = setTimeout(dequeue, (_b = (_a = err.options.retryAfter) !== null && _a !== void 0 ? _a : options.interval) !== null && _b !== void 0 ? _b : DEFAULT_WAIT);
                    }
                    else {
                         ...
                         */
                        await new Promise((r) => { var _a, _b; return setTimeout(r, (_b = (_a = err.options.retryAfter) !== null && _a !== void 0 ? _a : options.interval) !== null && _b !== void 0 ? _b : DEFAULT_WAIT); });
                    }
...
export function seconds(numSeconds) {
    return getNumber(numSeconds) * 1000;
}
export function minutes(numMinutes) {
    return getNumber(numMinutes) * seconds(60);
}
export function hours(numHours) {
    return getNumber(numHours) * minutes(60);
}
//# sourceMappingURL=throttledQueue.mjs.map