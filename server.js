...
<body>
  <div class="container">
    ...
    <div class="links">
      <a href="/signup">Dont have an account? Sign Up</a><br />
      <a href="/forgot-password">Forgot your password?</a><br />
      <a href="/landing-two">Back to Home</a>
    </div>
    <div
      style="margin-top:1.5rem;padding:1rem;background:#e5e5e5;border-radius:8px;border-left:4px solid #666666"
    >
      <p style="margin:0;color:#333333;font-size:0.9rem">
        <strong>Security Tip:</strong> After signing in, enable Two-Factor Authentication (2FA) to protect
        your account. You will see a prompt on your dashboard.
      </p>
    </div>
  </div>

  <script>
    console.log("[OK] Signin page JavaScript loaded");
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      form.addEventListener("submit", async function (e) {
        ...
        try {
          console.log("[HTTP] Sending login request to server...");
          ...
          if (data.success) {
            console.log("[OK] Login successful - cookie set, redirecting...");
            // IMPORTANT: Auth uses HttpOnly cookie only. Do not add token or role to URL.
            setTimeout(() => {
              window.location.replace("/dashboard/authenticated");
            }, 200);
          } else if (data.requires2FA) {
            console.log("[2FA] 2FA required");
            twoFactorGroup.style.display = "block";
            messageDiv.textContent = "Please enter your 2FA code";
            ...
            if (data.twoFactorMethod === "email") {
              ...
              messageDiv.textContent =
                "2FA code sent to your email. Please check and enter it below.";
            }
          } else {
...
<body>
  <div class="container">
    ...
    <div class="journey">
      <h3>Your Registration Journey</h3>
      <div class="steps">
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      form.addEventListener("submit", async function (e) {
        ...
        try {
          ...
          if (data.success) {
            console.log("[OK] Registration successful - cookie set, redirecting...");
            // IMPORTANT: Auth uses HttpOnly cookie only. Do not add token or role to URL.
            setTimeout(() => {
