...
function sendEmail(to, subject, message, type = 'info') {
  ...
  console.log(`≡ƒôº EMAIL SENT [${type.toUpperCase()}]:`, emailLog);
...
function createTGTWallet(userEmail) {
  ...
  console.log('≡ƒÆ░ WALLET CREATED:', walletInfo);
  return walletInfo;
}
...
const tgtPool = {
  ...
  deposit(amount, from, contractId) {
    ...
    console.log('≡ƒÆ░ TGT POOL DEPOSIT:', deposit);
    return deposit;
  },
  ...
  withdraw(amount, to, contractId) {
    ...
    console.log('≡ƒÆ╕ TGT POOL WITHDRAWAL:', withdrawal);
    return withdrawal;
  }
};
...
app.post('/api/admin/update-settings', (req, res) => {
  try {
    ...
    console.log('ΓÜÖ∩╕Å ADMIN SETTINGS UPDATED:', platformSettings);
...
app.post('/api/admin/approve-kyc', async (req, res) => {
  try {
    ...
    console.log('Γ£à ADMIN KYC APPROVAL:', kycId);
...
app.post('/api/create-dual-contract', async (req, res) => {
  try {
    ...
    console.log('≡ƒöä DUAL CONTRACT CREATED:', tradeData);
...
<head>
  ...
  <title>Tangent Protocol ΓÇö Advanced Trading Platform & TGT Stablecoin</title>
  <style>
    body { 
...
<body>
  <div class="container">
    ...
    <div class="status">
      <h3>≡ƒÜÇ Platform Status</h3>
      <p><strong>Server:</strong> Γ£à Online and Running</p>
      <p><strong>DNS Routing:</strong> Γ£à Working</p>
      <p><strong>SSL Certificates:</strong> Γ£à Active</p>
      <p><strong>Version:</strong> TANGENT-RESTORE-24-ULTIMATE-${Date.now()}</p>
      <p><strong>Last Updated:</strong> ${new Date().toISOString()}</p>
    </div>
    
    <div style="margin-top: 30px; text-align: center;">
      <a href="/test" style="color: #2563eb; text-decoration: none; margin: 0 15px;">≡ƒº¬ Test Server</a>
      <a href="/health" style="color: #2563eb; text-decoration: none; margin: 0 15px;">≡ƒôè Health Check</a>
    </div>
    
    <!-- Team Access Section -->
    <div style="text-align: center; margin-top: 40px; padding: 30px; border-top: 1px solid #334155; background: rgba(6, 182, 212, 0.05);">
      <p style="color: #94a3b8; font-size: 1rem; margin-bottom: 15px;">≡ƒöÉ Team members & new users</p>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Team Access ΓÇö Tangent Protocol</title>
  <style>
...
<body>
  <div class="container">
    ...
    <div style="margin-top: 40px;">
      <a href="/" style="color: #06b6d4; text-decoration: none;">ΓåÉ Back to Landing Page</a>
    </div>
  </div>
</body>
</html>`;
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Sign In ΓÇö Tangent Protocol</title>
  <style>
    body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; background: #0f172a; color: #f8fafc; margin: 0; padding: 40px; }
...
<body>
  <div class="container">
    ...
    <div class="back-link">
      <a href="/landing-two">ΓåÉ Back to Team Access</a>
    </div>
  </div>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Sign Up ΓÇö Tangent Protocol</title>
  <style>
    body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; background: #0f172a; color: #f8fafc; margin: 0; padding: 40px; }
...
<body>
  <div class="container">
    ...
    <div style="margin-top: 40px; text-align: center;">
      <button class="btn ghost" onclick="window.location.href='/landing-two'">ΓåÉ Back to Team Access</button>
    </div>
  </div>
    ...
    document.getElementById("kycForm").addEventListener("submit", async function(e) {
      ...
      try {
        ...
        if (response.ok && result.success) {
          alert("≡ƒÄë KYC application submitted successfully! You will be notified once verification is complete.");
          window.location.href = "/dashboard";
        } else {
...
<body>
  <div class="container">
    ...
    <h1>≡ƒôè Tangent Protocol Dashboard</h1>
    <div class="status">Γ£à Welcome to your dashboard</div>
    
    <div class="grid">
      <div class="card">
        <h3>≡ƒÆ╝ Upload Transactions</h3>
    ...
    <div style="margin-top: 40px; text-align: center;">
      <button class="btn ghost" onclick="window.location.href='/'">ΓåÉ Back to Landing Page</button>
    </div>
  </div>
</body>
</html>`;
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Sign Up & KYC ΓÇö Tangent Protocol</title>
  <style>
...
<body>
  <div class="container">
    <div class="header">
      <h1>≡ƒô¥ Account Registration & KYC</h1>
      ...
      <div class="kyc-section">
        ...
        <div class="company-types">
          <div class="company-type" onclick="selectCompanyType('listed')" id="listed-company">
            <h4>≡ƒôê Listed Company</h4>
            <p style="color: #94a3b8; margin: 10px 0;">Publicly traded corporation</p>
            <ul class="doc-list">
              <li>ΓÇó Certificate of Incorporation</li>
              <li>ΓÇó Annual Report (Latest)</li>
              <li>ΓÇó Stock Exchange Filing</li>
              <li>ΓÇó Board Resolution</li>
              <li>ΓÇó Beneficial Ownership (25%+)</li>
              <li>ΓÇó Audited Financial Statements</li>
            </ul>
          </div>
          
          <div class="company-type" onclick="selectCompanyType('private')" id="private-company">
            <h4>≡ƒÅó Private Company</h4>
            <p style="color: #94a3b8; margin: 10px 0;">Privately held corporation</p>
            <ul class="doc-list">
              <li>ΓÇó Certificate of Incorporation</li>
              <li>ΓÇó Articles of Association</li>
              <li>ΓÇó Shareholders Register</li>
              <li>ΓÇó Directors Register</li>
              <li>ΓÇó Beneficial Ownership Info</li>
              <li>ΓÇó Financial Statements</li>
              <li>ΓÇó Business License</li>
            </ul>
          </div>
        </div>
    ...
    <a href="/landing-two" class="back-link">ΓåÉ Back to Team Portal</a>
  </div>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Document Upload ΓÇö Tangent Protocol</title>
  <style>
    body { font-family: system-ui; background: #0f172a; color: #f8fafc; margin: 0; padding: 20px; }
...
app.get('/tgt-info', (req, res) => {
  res.send('<h1>≡ƒÆÄ TGT Information</h1><p>Coming soon...</p><p><a href="/">ΓåÉ Back</a></p>');
});

app.get('/portal', (req, res) => {
  res.send('<h1>≡ƒÜÇ Portal Home</h1><p><a href="/dashboard">Go to Dashboard</a></p>');
});

app.get('/admin', (req, res) => {
  res.send('<h1>ΓÜÖ∩╕Å Admin Panel</h1><p><a href="/dashboard">Go to Dashboard</a></p>');
});
...
app.post('/api/create-contract', async (req, res) => {
  try {
    ...
    console.log('≡ƒôï CONTRACT CREATED:', contract);
...
app.post('/api/confirm-contract', async (req, res) => {
  try {
    ...
    console.log('Γ£à CONTRACT CONFIRMED:', contract);
...
app.post('/api/make-deposit', async (req, res) => {
  try {
    ...
    console.log('≡ƒÆ░ DEPOSIT COMPLETED:', { contractId, deposit });
...
app.post('/api/upload-contract-documents', upload.array('documents', 10), async (req, res) => {
  try {
    ...
    console.log('≡ƒôä CONTRACT DOCUMENTS UPLOADED:', { contractId, documentCount: documentPaths.length });
...
app.post('/api/release-payment', async (req, res) => {
  try {
    ...
    console.log('≡ƒÆ╕ PAYMENT RELEASED:', { contractId, finalAmount, totalFees });
...
function triggerAuction(contractId, contract) {
  ...
  console.log('≡ƒÅ║ AUCTION TRIGGERED:', auctionId);
...
app.post('/api/place-bid', async (req, res) => {
  try {
    ...
    console.log('≡ƒö¿ BID PLACED:', { auctionId, bidderEmail, bidAmount });
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Admin Dashboard ΓÇö Tangent Protocol</title>
  <style>
    body { font-family: system-ui; background: #0f172a; color: #f8fafc; margin: 0; padding: 20px; }
...
<body>
  ...
  <div class="header">
    <h1>ΓÜÖ∩╕Å Admin Dashboard</h1>
    <p>Platform Management & Control Center</p>
  </div>
  
  <div class="dashboard-grid">
    <div class="dashboard-card">
      <h3>≡ƒÆ░ Platform Configuration</h3>
    ...
    <div class="dashboard-card">
      <h3>≡ƒÜ¿ Alerts & Flags</h3>
      <p>2 Price Alerts</p>
      <a href="/admin/flags" class="btn">Review Flags</a>
    </div>
    
    <div class="dashboard-card">
      <h3>≡ƒÅ¢∩╕Å Auction Board</h3>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Buyer Dashboard ΓÇö Tangent Protocol</title>
  <style>
    body { font-family: system-ui; background: #0f172a; color: #f8fafc; margin: 0; padding: 20px; }
    .header { background: #1e293b; padding: 20px; border-radius: 12px; margin-bottom: 30px; border: 1px solid #334155; }
    .header h1 { color: #2563eb; margin: 0; font-size: 2.5rem; }
...
<body>
  ...
  <div class="header">
    <h1>≡ƒ¢Æ Buyer Dashboard</h1>
    <p>Manage your purchase contracts and deposits</p>
  </div>
  
  <div class="dashboard-grid">
    <div class="dashboard-card">
      <h3>≡ƒô¥ Create New Contract</h3>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Supplier Dashboard ΓÇö Tangent Protocol</title>
  <style>
    body { font-family: system-ui; background: #0f172a; color: #f8fafc; margin: 0; padding: 20px; }
    .header { background: #1e293b; padding: 20px; border-radius: 12px; margin-bottom: 30px; border: 1px solid #334155; }
...
<body>
  ...
  <div class="header">
    <h1>≡ƒÅ¡ Supplier Dashboard</h1>
    <p>Manage your supply contracts and deliveries</p>
  </div>
  
  <div class="dashboard-grid">
    <div class="dashboard-card">
      <h3>≡ƒôº Contract Confirmations</h3>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Trader Dashboard ΓÇö Tangent Protocol</title>
  <style>
    body { font-family: system-ui; background: #0f172a; color: #f8fafc; margin: 0; padding: 20px; }
    .header { background: #1e293b; padding: 20px; border-radius: 12px; margin-bottom: 30px; border: 1px solid #334155; }
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Insurer Dashboard ΓÇö Tangent Protocol</title>
  <style>
    body { font-family: system-ui; background: #0f172a; color: #f8fafc; margin: 0; padding: 20px; }
    .header { background: #1e293b; padding: 20px; border-radius: 12px; margin-bottom: 30px; border: 1px solid #334155; }
...
process.on('unhandledRejection', (reason, promise) => {
  console.error('Γ¥î Unhandled Rejection:', reason);
});
...
console.log('≡ƒÜÇ Starting Tangent Ultimate Platform...');
...
const server = app.listen(PORT, HOST, (err) => {
  ...
  console.log(`Γ£à TANGENT ULTIMATE PLATFORM RUNNING ON PORT ${PORT}`);
  console.log(`≡ƒîÉ Landing Page: http://${HOST}:${PORT}/`);
  console.log(`≡ƒöÉ Team Portal: http://${HOST}:${PORT}/landing-two`);
  console.log(`Γ¥ñ∩╕Å Health Check: http://${HOST}:${PORT}/health`);
  console.log('≡ƒÄ» ALL FUNCTIONALITIES RESTORED!');
});
